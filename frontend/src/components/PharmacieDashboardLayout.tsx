...
interface PharmacieDashboardLayoutProps {
  children: React.ReactNode;
}

export default function PharmacieDashboardLayout({ children }: PharmacieDashboardLayoutProps) {
  ...
  const navigation = [
    { name: 'Tableau de bord', href: '/dashboard/pharmacie', icon: Home, current: pathname === '/dashboard/pharmacie' },
    { name: 'Annonces', href: '/dashboard/pharmacie/annonces', icon: FileText, current: pathname.startsWith('/dashboard/pharmacie/annonces') },
    { name: 'Demandes', href: '/dashboard/pharmacie/demandes', icon: ShoppingCart, current: pathname.startsWith('/dashboard/pharmacie/demandes') },
  ];
      ...
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            {/* Logo */}
            <Link href="/dashboard/pharmacie" className="flex items-center">
            ...
            <div className="flex items-center gap-4">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-56" align="end">
                  ...
                  <DropdownMenuSeparator />
                  <DropdownMenuItem onClick={() => router.push('/dashboard/pharmacie/profil')} className="flex items-center cursor-pointer">
                    <User className="mr-2 h-4 w-4 text-gray-600" />
                    <span>Mon profil</span>
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={() => router.push('/dashboard/pharmacie/support')} className="flex items-center cursor-pointer">
